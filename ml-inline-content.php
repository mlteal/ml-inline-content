...
define( 'MLIC_VERSION', '1.0' );
define( 'MLIC_PLUGIN_DIR', plugin_dir_path( __FILE__ ) );
define( 'MLIC_PLUGIN_URL', plugins_url( '/', __FILE__ ) );

require_once( MLIC_PLUGIN_DIR . '/class-ml-inline-content.php' );
